...
1. Fill in the blanks, so the print statement displays the result of the function call in order.<br>
   <b>Hint</b>: if a function returns multiple values, don't forget to store these values in multiple variables
